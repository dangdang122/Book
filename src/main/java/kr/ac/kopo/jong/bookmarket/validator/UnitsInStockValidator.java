package kr.ac.kopo.jong.bookmarket.validator;
...
public class UnitsInStockValidator implements Validator {
    ...
    public void validate(Object target, Errors errors){
        ...
        if(unitPrice != null & unitPrice.intValue() >= 10000 && unitsInStock > 99){
            errors.rejectValue("unitsInStock", "UnitsInStockValidator.message", "가격 10000원원 이상인 경우에는 100개 이상을 재고량으로 등록할 수 없습니다");
        }
    }
}
